...
test('[get] failure, throws error if no id provided', () => {
  assert.throws(() => mvtf.get(), /No fixture id provided/);
});

test('[get] failure, throws error if fixture does not exist', () => {
  assert.throws(() => mvtf.get('beep-boop'), /Error loading fixture/);
});

test('[get] success, gets a fixture and its properties/buffer', () => {
